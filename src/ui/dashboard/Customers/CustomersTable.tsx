  ...
  return (
    <>
      <tr className="odd:bg-blue-50">
        ...
        <td className="p-4 text-sm text-black">CompanyName|N/A</td>
        <td className="p-4 text-sm text-black">Country</td>
        <td className="p-4 text-sm text-black">Email</td>
        <td className="p-4 text-sm text-black">Phone</td>
        <td className="p-4 text-sm text-black">Supporter</td>
        <td className="p-4">
